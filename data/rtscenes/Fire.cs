...
AnimatedColor smoothFire = VolumeCube.Fire(fireShape, noise, noise, fireColorYellow, 1.0);
AnimatedColor fire = VolumeCube.Fire(fireShape, turbulence, noise, fireColorYellow, 1.0);
AnimatedColor chaoticFire = VolumeCube.Fire(fireShape, turbulence, turbulence, fireColorYellow, 1.0);

AnimatedColor smoothFireBlue = VolumeCube.Fire(fireShape, noise, noise, fireColorBlue, 1.0);
...
AnimatedColor cloud = VolumeCube.Cloud(ellipsoid, displ, turbulence, fireColorBlue, 1.0);

//Color displ = VolumeCube.Displacement(VolumeCube.Turbulence(VolumeCube.Noise3d(), 4));
Func<Vector4d, double> noise4d = VolumeCube.Noise4d();

/*AnimatedColor cloud = (v, t) =>
{
...
root.InsertChild(c, Matrix4d.Scale(15) * Matrix4d.RotateY(0.6) * Matrix4d.CreateTranslation(-12.0, 1.0, 10.0));
